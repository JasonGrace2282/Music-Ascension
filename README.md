...
<br><br><b>Note:</b> If the program could not access the location of an image, you might need to go into your IDE's run configuration and add the folder "<p style="font-family:Consolas">code</p>" to the end of it. Alternatively, if your IDE has a terminal (like VSCode for example), all you need to do is go into the terminal and type "<p style="font-family:Consolas"><a style="color:orange">cd code</a></p>"
